...
po.src = '//thrivesmarter.com/livehelper/index.php/chat/getstatus/(click)/internal/(position)/bottom_right/(ma)/br/(top)/350/(units)/pixels/(leaveamessage)/true?r='+refferer+'&l='+location;
		...
		<div class="large-4 columns">
			<ul class="pricing-table featured">
			  ...
			  <li class="price">$9/Month</li>
			   ...
			   <li class="price">
			   <input type="radio" name="subcription" checked onclick="month()">Monthly
			   <input type="radio" name="subcription" onclick="year()">Yearly</li>
		...
		<div class="large-4 columns" style="margin-top:-15px;">
			<ul class="pricing-table featured3">
			  ...
			  <li class="price">$19/Month</li>
			   ...
			   <li class="price"><input type="radio" name="subcription" checked onclick="month()">Monthly
			   <input type="radio" name="subcription" onclick="year()">Yearly</li>
			  <li class="cta-button"><input type="submit" class="button secondary radius" value="Buy Now"></li>
			</ul>
		</div>
